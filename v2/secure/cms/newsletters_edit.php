...
if(post('save') == 'yes')
{
	...
	if($errors == '')
	{
		$db->Execute("update ".DB_TABLE_PREFIX."newsletters set name = ".$db->qstr($name).", subject = ".$db->qstr($subject).", message = ".$db->qstr($message)." where id = '$id'");
		$msg = urlencode('Newsletter updated successfully.');
...
$g_section_heading = 'Modify Newseltter';
            ...
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="one_px_bdr">
                <tr>
                  ...
                  <td width="75%" align="left"><input name="name" type="text"  id="name" class="text" size="30" maxlength="128" value="<?=$name?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left">
                    ...
                    <textarea id="message" name="message" rows="15" class="mce" cols="80" style="width: 100%; height:500px;"><?=$message?></textarea>
                  </td>
                </tr>
                <tr>
                  <td align="left" class="data_row">* required
                    <input name="save" type="hidden" id="save" value="yes" />
					<input name="id" type="hidden" id="id" value="<?=get('id');?>" />
					</td>
                  <td align="left"><input name="Submit" type="submit" class="submit" value="Update Newsletter" />                    </td>
                </tr>
				<tr>
