...
if(post('save') == 'yes')
{
	...
	if($errors == '')
	{
		$db->Execute("insert into ".DB_TABLE_PREFIX."subscribers set name = ".$db->qstr($name).", email = ".$db->qstr($email).", phone = ".$db->qstr($phone).", date_added = '".date('Y-m-d H:i:s')."'");
		...
		else
		{
			...
			$msg = urlencode('Subscriber added successfully.');
...
$g_section_heading = 'Add Subscriber';
            ...
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="one_px_bdr">
                <tr>
                  ...
                  <td width="75%" align="left"><input name="name" type="text" class="text" id="name" size="30" maxlength="64" value="<?=$name?>" /></td>
                </tr>
                <tr>
                  <td align="left" class="data_row"> E-mail Address: * </td>
                  <td align="left"><input name="email" type="text"  id="email" class="text" size="30" maxlength="255" value="<?=$email?>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input name="Submit" type="submit" class="submit" value="Add Subscriber" />                    </td>
                </tr>
              </table>
            </form>
          <!-- InstanceEndEditable -->
