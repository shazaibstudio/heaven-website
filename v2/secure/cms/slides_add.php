...
if(post('save') == 'yes')
{
	...
	if($_FILES['src_image_file']['tmp_name'] == '')
		$errors .= '- Please upload slide image.<br />';
	else
	{
	...
	if($errors == '')
	{
		...
		$sql = "insert into ".DB_TABLE_PREFIX."slides set 
		...
		$db->Execute($sql);
		$msg = urlencode('Slide added successfully.');
            ...
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="one_px_bdr">
                ...
                <tr>
                  ...
                  <td class="td_bdr"><input name="src_image_file" type="file" id="src_image_file" size="30" class="text" />
                    (Only .JGP, .PNG or .GIF images)</td>
                </tr>
                <tr>
