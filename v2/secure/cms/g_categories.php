...
if(post('act') == 'status')
{
	...
	redirect("g_categories.php?msg=$msg&page=".post('page'));
}
...
$g_section_heading = 'Manage Galleries';
$g_page_title = $g_section_heading.' - '.$g_page_heading;
$add_link = array('caption' => 'Add Gallery', 'link' => 'g_categories_add.php');	
?>
        ...
        <div class="content-box">
          ...
          <div class="box-body clear"> 
            ...
            <!-- InstanceBeginEditable name="txt" -->
				  ...
				  <?
				  $sql = "select * from ".DB_TABLE_PREFIX."categories where parent_id = '0' and type = 'gallery' order by pos, name asc";
				  ...
				  ?>
                    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="datatable">
                      ...
                      <tr>
                        ...
                        <th width="23%" align="left" class="td_heading">No of Pictures</th>
                        <th width="17%" align="left" class="td_heading">Position</th>
					  ...
					  while(!$result->EOF)
					  {
						...
						$t = $db->GetOne("SELECT COUNT(id) AS t FROM ".DB_TABLE_PREFIX."pictures WHERE cat_id = '$id'");
					  ?>
					  <tr <?=$class?>>
                        ...
                        <td align="left"><a href="g_pictures.php?cat_id=<?=$id;?>"><?=$t.' Pictures';?></a></td>
