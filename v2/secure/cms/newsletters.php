...
if(req('act') == 'delete')
{
	...
	for($i = 0 ; $i < sizeof($ids) ; $i++)
		$db->Execute("delete from ".DB_TABLE_PREFIX."newsletters where id = '".$ids[$i]."'");		
	
	$msg = urlencode('Newsletter(s) deleted successfully.');
	redirect("newsletters.php?msg=$msg&page=".post('page'));
}

$g_page_heading = 'Newsletters';
$g_section_heading = 'Manage Newsletters';
$g_page_title = $g_section_heading.' - '.$g_page_heading;
$add_link = array('caption' => 'Add Newsletter', 'link' => 'newsletters_add.php');	
?>
        ...
        <div class="content-box">
          ...
          <div class="box-body clear"> 
            ...
            <!-- InstanceBeginEditable name="txt" -->
				  ...
				  <?
				  $sql = "select * from ".DB_TABLE_PREFIX."newsletters order by name asc";
				  ...
				  ?>
                    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="datatable">
                      ...
                      <tr>
                        ...
                        <th width="32%" height="24" align="left" class="td_heading">Name</th>
                        <th width="18%" align="left" class="td_heading">Date Created </th>
                        <th width="16%" align="left" class="td_heading">Send Newsletter </th>
                        <th width="18%" align="left" class="td_heading">Date Sent </th>
					  ...
					  <tr <?=$class?>>
                        ...
                        <td align="left"><a href="newsletters_send.php?id=<?=$id;?>">Send Newsletter</a> </td>
                        <td align="left"><? if($result->fields('date_sent') == '') echo 'N/A'; else echo date('M d, Y H:i:s', strtotime($result->fields('date_sent')));?></td>
                        <td align="left"><a href="newsletters_edit.php?id=<?=$id;?>&amp;page=<?=get('page')?>"><img src="images/ico_edit_16.png" class="icon16 fl-space2" alt="" title="edit" /></a> <a href="<?=$_SERVER['PHP_SELF'];?>?act=delete&amp;del_id[]=<?=$id;?>" onclick="return window.confirm('Are you sure, you want to delete this record?');"><img src="images/ico_delete_16.png" class="icon16 fl-space2" alt="" title="delete" /></a></td>
                      </tr>
					  <?
					  	$result->MoveNext();
					  }	$result->Close();
