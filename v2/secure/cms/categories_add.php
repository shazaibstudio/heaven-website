...
if(post('save') == 'yes')
{
	...
	if($errors == '')
	{
		...
		$db->Execute("insert into ".DB_TABLE_PREFIX."categories set page_id = '$page_id', parent_id = '$parent_id', name = ".$db->qstr($name).", seo_name = ".$db->qstr($seo_name).", description = ".$db->qstr($description)." $sql_menu , pos = ".$db->qstr($pos).", status = ".$db->qstr($status)."");
...
$g_section_heading = 'Add Category';
          ...
          <div class="box-body clear"> 
            ...
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="one_px_bdr">
                <tr>
                  <?php /*?><td align="left" class="data_row">Parent Category: </td>
                  <td align="left">
                ...
                <tr>
                  ...
                  <td width="75%" align="left">
                    <label><input type="radio" name="page_id" id="page_id" value="4" <?php if($page_id == '4' || $page_id == '') echo 'checked="checked"'; ?> /> Salon Price List</label>
