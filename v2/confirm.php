...
<div class="col-sm-12 col-md-6">
  ...
  <h3>Billing Details</h3>    
    ...
    <tbody>
      ...
      <?php if($bill_to_address_state != '') { ?>

      <tr>
        <th>State:</th>
        <td>
            <?php
              echo $db->GetOne("SELECT name FROM ".DB_TABLE_PREFIX."states WHERE abbrev = '". $bill_to_address_state ."'");
            ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
            <?php
              echo $db->GetOne("SELECT name FROM ".DB_TABLE_PREFIX."countries WHERE iso_code_2 = '". $bill_to_address_country ."'");
            ?>
        </td>
      </tr>
      <tr>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><strong><?php echo get_price($room['price'], $room['price_pk']);?></strong></td>
                        <td class="text-center"><?php echo $nights; ?></td>
                        <td class="text-center"><strong><?php echo get_price($total, $total_pk);?></strong></td>
                    </tr>
                    <?
                      if(get_session('ses_visitor_country') == 'PK')
