...
{
    $nights = dateDifference($checkin, $checkout, '%d');
}

$_SESSION['ses_cart'][] = array('room_id' => $room, 'checkin' => $checkin, 'checkout' => $checkout, 'adults' => $adults, 'childern' => $children, 'nights' => $nights);


echo '<div class="alert alert-success alert-dismissable">
  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Success! Room added to your reservation list, <a href="reservation-overview.html">click here to proceed.</a></div>';
...
$address = "wahid@heavenhotel.com.pk";


// Configuration option.
$e_subject = 'A reservation request by ' . $name . '.';
...
$e_body = "A reservation has been requested by:
...
$e_reply = "Please contact the above customer to make the reservation complete, Thanks";
