...
jQuery(document).ready(function () {
    ...
    if (jQuery().gMap) {
        jQuery('#map').gMap({
            ...
            markers: [{
                address: "Khayaban-e-Jinnah, Main DHA Gate, Lahore Cant. Pakistan.", //Address of the company
                html: "<h4>Our hotel</h4><p>Heaven Hotel</p>", //Quicktip
                popup: false, //Boolean	
...
function check_country(country)
{
    ...
    else $('#div_states').addClass('hidden');
}